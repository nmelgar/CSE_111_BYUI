def main():
    ...
    end_miles = float(input("Enter the end odometer reading (miles): "))
    ...
    calculation = lp100k_from_mpg(mpg)
    # Display the results for the user to see.
    print(f"{mpg: .2f} miles per gallon")
    print(f"{calculation: .2f} litters per 100 kilometers")
